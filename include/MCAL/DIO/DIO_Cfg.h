...
#define PORTC_PIN3_DIRECTION  DIO_CFG_OUTPUT
...
#define PORTB_PIN0_VALUE  DIO_CFG_HIGH
#define PORTB_PIN1_VALUE  DIO_CFG_HIGH
#define PORTB_PIN2_VALUE  DIO_CFG_HIGH
#define PORTB_PIN3_VALUE  DIO_CFG_HIGH
